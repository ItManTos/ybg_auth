...
public class EntPayController {
	...
	@PostMapping("/entPay")
	public EntPayResult entPay(@PathVariable String appid, @RequestBody EntPayRequest request) throws WxPayException {
		return getWxService(appid).getEntPayService().entPay(request);
	}
	...
	public String getPublicKey(@PathVariable String appid) throws WxPayException {
		return getWxService(appid).getEntPayService().getPublicKey();
	}
	...
	@PostMapping("/payBank")
	public EntPayBankResult payBank(@PathVariable String appid, EntPayBankRequest request) throws WxPayException {
		return getWxService(appid).getEntPayService().payBank(request);
	}
	...
	public EntPayQueryResult queryEntPay(@PathVariable String appid, @PathVariable String partnerTradeNo)
			throws WxPayException {
		return getWxService(appid).getEntPayService().queryEntPay(partnerTradeNo);
	}
	...
	public EntPayBankQueryResult queryPayBank(@PathVariable String appid, @PathVariable String partnerTradeNo)
			throws WxPayException {
		return getWxService(appid).getEntPayService().queryPayBank(partnerTradeNo);
	}
